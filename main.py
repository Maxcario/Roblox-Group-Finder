...
def groupfinder():
    try:
        id = random.randint(10000, 11500000)
...
#your webhook
hook = input("https://discord.com/api/webhooks/1254894334524915853/_CIi99yrEazxWE6YX_JGyl3duhufEHs_IVmQssk0BNicl_4KpwuaYwg1KPjvsF3XpOVm")
#number of threads
threads = int(input(1))
